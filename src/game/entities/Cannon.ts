...
import { boardConfig, BubbleType } from "../../systems/boardConfig";
import { BubbleView } from "./BubbleViews";
...
export class Cannon {
  ...
  public set rotation(value: number) {
    ...
    this._parts["cannon-barrel"].rotation = this._parts[
      "cannon-arrow"
    ].rotation = value;
  }
  ...
  public set type(value: BubbleType | "empty") {
    ...
    if (value === "empty") {
      ...
      this._parts["cannon-arrow"].tint = this._parts[
        "cannon-main"
      ].tint = 0xffffff;
